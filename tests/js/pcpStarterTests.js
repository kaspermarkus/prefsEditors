...
(function ($) {
    ...
    fluid.defaults("gpii.tests.pcpStarterTester", {
        ...
        modules: [{
            ...
            tests: [{
                ...
                expect: 1,
                name: "create set of adjusters to show",
                func: "gpii.tests.pcpStarter.testBaseAdjustersCreation",
                args: "{starter}"
            }]
        }]
    });
    ...
    gpii.tests.pcpStarter.testBaseAdjustersCreation = function (starter) {
        jqUnit.assertDeepEq("The starter component generates its model-depending adjuster names to grade merge", starter.baseAdjusters, expectedAdjusterNames);
    };
